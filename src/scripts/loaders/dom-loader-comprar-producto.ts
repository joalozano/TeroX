...
import { productoTableDef, tableDefs } from '../config/estructuras.js';

import { url_editar_producto_view, url_productos } from '../config/rutas.js';
...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    agregar_evento_submit_form(form, url_orden, mensajeExito, 
        mensajeError, hacerNada, hacerNada, 'POST');
